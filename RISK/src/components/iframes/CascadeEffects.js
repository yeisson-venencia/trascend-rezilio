...
class CascadeEffects extends React.Component {
  constructor(props) {
    super(props);
        ...
        <div class="h-screen">
          <div className={styles.menuRezilio}>
            <div class="d-flex flex-col justify-center items-center mx-4 mt-3 ">
              ...
              />
              <iframe
                src="https://demo.qhere.es/en/cascadeeffect/cascadeeffects?iframe=1"
                width="80%"
              ></iframe>
            </div>
          </div>
...
export default connect(mapStateToProps)(withRouter(CascadeEffects));
