...
class SideBar extends React.Component {
  ...
  render() {
    const { idPage, idComponent } = this.props;
    ...
    return (
      <ul class="dropdown-menu">
        ...
        <li
          className={`${
            idComponent === "ListThreat" ? "bg-light " : "bg-white text-black"
          }`}
        >
          <Link
            class="dropdown-item"
            to={{
              pathname: buildUrl("LIST_THREATS", idPage),
            }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li
          className={`${
            idComponent === "ListExposed" ? "bg-light " : "bg-white text-black"
          }`}
        >
          <Link
            class="dropdown-item"
            to={{
              pathname: buildUrl("LIST_EXPOSED", idPage),
            }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li
          className={`${
            idComponent === "ListSite" ? "bg-light " : "bg-white text-black"
          }`}
        >
          <Link
            class="dropdown-item "
            to={{
              pathname: buildUrl("LIST_SITES", idPage),
            }}
            onClick={() => this.props.handleClick("list")}
          >
            {/* <button onClick={() => this.props.handleClick("list")}> */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <li
          className={`${
            idComponent === "ListRisk" ? "bg-light " : "bg-white text-black"
          }`}
        >
          <Link
            class="dropdown-item"
            to={{
              pathname: buildUrl("LIST_RISK", idPage),
            }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <Link
            class="dropdown-item"
            to={{ pathname: buildUrl("EDIT_PROJECT", idPage) }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <li>
          <Link
            class="dropdown-item"
            to={{ pathname: buildUrl("DIRECT_IMPACTS", idPage) }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <li>
          <Link
            class="dropdown-item"
            to={{ pathname: buildUrl("INTERDEPENDENCES", idPage) }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <li>
          <Link
            class="dropdown-item"
            to={{ pathname: buildUrl("SIMULATOR", idPage) }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
        ...
        <li>
          <Link
            class="dropdown-item"
            to={{ pathname: buildUrl("CASCADE", idPage) }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
